...
class SensorUpdator:
    ...
    def update(self, sensorName: str, sensorState: float, sensorUnit: str, state_class: str = "total_increasing"):
        token = os.getenv(
            "SUPERVISOR_TOKEN") if self.base_url == SUPERVISOR_URL else self.token
        headers = {
